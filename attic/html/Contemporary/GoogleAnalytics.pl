...
{ 
  $data =~ s/<head>/<head>\n<script async src=\"https:\/\/www.googletagmanager.com\/gtag\/js?id=UA-141518510-1\"><\/script> <script> window.dataLayer = window.dataLayer \|\| \[\]; function gtag(){dataLayer.push(arguments);} gtag(\'js\', new Date()); gtag(\'config\', \'UA-141518510-1\');<\/script>/gs;
