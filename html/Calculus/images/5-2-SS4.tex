...
\begin{document}
 ...
 \begin{tikzpicture}[xscale=1,yscale=0.5]
	...
	\draw[-,name path=A,smooth,domain=-1:2,very thick,black] plot(\x,{\x*\x-2});
	\draw[-,name path=B,smooth,domain=-1:2,very thick,black] plot(\x,{\x});
	\draw[-,smooth,domain=-2:3,very thick,black] plot(\x,{\x*\x-2});
	\draw[-,smooth,domain=-2:3,very thick,black] plot(\x,{\x});
