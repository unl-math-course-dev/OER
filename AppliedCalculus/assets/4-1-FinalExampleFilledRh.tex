...
\foreach \t in {0,0.2,0.4,0.6,0.8,1,1.2,1.4,1.6,1.8} \draw[fill=yellow, fill opacity=0.2] (\t,0) -- (\t,{f(\t+0.2)}) -- ({\t+0.2}, {f(\t+0.2)}) -- ({\t+0.2},0);

\foreach \t in {2,2.2,2.4,2.6,2.8,3,3.2,3.4,3.6,3.8} \draw[fill=yellow, fill opacity=0.2] (\t,0) -- (\t,{g(\t+0.2)}) -- ({\t+0.2}, {g(\t+0.2)}) -- ({\t+0.2},0);
