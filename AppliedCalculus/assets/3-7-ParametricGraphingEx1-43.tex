...
\draw[fill=black] (0,1) circle (0.05cm) node[above] {$t=\pi/6$};
\draw[fill=black] (-1,0) circle (0.05cm) node[above left] {$t=\pi/3$};
\draw[fill=black] (0,-1) circle (0.05cm) node[below] {$t=\pi/2$};
